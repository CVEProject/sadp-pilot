...
Here ([CVE-2025-14174](https://github.com/CVEProject/sadp-pilot/examples/blob/main/CVE-2025-14174_with_sadp.json)) is an manually generated example CVE Record with an SADP container. Look for `x_` field names.
